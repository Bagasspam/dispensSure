...
function getInterpolatedColor(value, minValue, maxValue, colorStops) {
  ...
  let segmentIndex = 0;
  while (segmentIndex < colorStops.length - 1 && factor > colorStops[segmentIndex + 1].position) {
    segmentIndex++;
  }
  ...
  const segmentFactor = (factor - startSegment.position) / (endSegment.position - startSegment.position);
...
function App() {
  ...
  useEffect(() => {
    ...
    // Contoh: websocket.current = new WebSocket('wss://your-backend-name.onrender.com');
    ...
    websocket.current.onmessage = event => {
      try {
        ...
        setTempData(prev => {
          const newTempData = [...prev, { x: newTimestamp, y: data.temperature }];
    ...
    <div className="App">
      ...
      <div className="dashboard-container">
          ...
          <div className="data-card">
            ...
            <div className="gauge-wrapper">
              <CircularProgressbar
                ...
                styles={buildStyles({
                  pathColor: getInterpolatedColor(currentTds, 0, TDS_MAX_GAUGE, TDS_COLOR_STOPS),
          ...
          <div className="data-card">
            ...
            <div className="gauge-wrapper">
              <CircularProgressbar
                ...
                styles={buildStyles({
                  pathColor: getInterpolatedColor(currentTemp, 0, TEMP_MAX_GAUGE, TEMP_COLOR_STOPS),
                  textColor: 'var(--text-color)',
                  trailColor: 'rgba(255, 255, 255, 0.2)',
                  backgroundColor: 'var(--card-bg)',
                })}
        ...
        <div className="chart-section">
          ...
          <div className="chart-canvas-wrapper" style={{ height: '350px', width: '100%' }}>
